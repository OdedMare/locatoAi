...
const AREA_SUMMARY_EXAMPLES = [
  { text: "נמצאו בית מגורים אחד ובית כנסת אחד בתוך תא השטח.", source: "שכבת בתים ובתי כנסת" },
  { text: "נמצא בית ספר אחד במרחק 120 מ׳ מגבול תא השטח.", source: "שכבת בתי ספר" },
  { text: "עודד הגיע לאזור זה לפני כ־3 שעות.", source: "שכבת הגעות חברים" },
  { text: "בשעה 14:00 עודד ומשה שהו כאן יחד.", source: "שכבת הגעות חברים" },
  { text: "אירוע בטחוני דווח כאן אתמול בשעה 21:30.", source: "שכבת אירועים" },
  { text: "שכבת האירועים לא הייתה זמינה בעת הבדיקה — הסיכום חלקי.", source: "כשל בכיסוי" },
];
