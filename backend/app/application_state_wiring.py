...
def _services(
    ...
    return (
        catalog, llm, selector, metadata, orchestrator, area_summary, ranking,
    )


def _assign(
    app, store, repository, provider_bundle, services, settings, agent_content,
) -> None:
