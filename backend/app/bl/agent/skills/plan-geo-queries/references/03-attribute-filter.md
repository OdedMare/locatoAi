...
**Compose:** Use the latest subject-chain step as input. Use normalized `contains` for ordinary text, `fuzzy_contains` only for an apparent spelling or transliteration variant, and numeric operators only for numeric fields.
