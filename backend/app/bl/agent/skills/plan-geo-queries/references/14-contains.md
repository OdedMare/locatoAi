...
**Compose:** Direction is strict: input contains target. Use the latest subject-chain step as input. A named target requires its complete filter. Add the reference layer to `context_layers`.
