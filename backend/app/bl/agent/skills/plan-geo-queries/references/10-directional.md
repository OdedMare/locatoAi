...
Use the latest subject-chain step as input. Omit `count` for a singular extreme and set the requested count otherwise. This ranks static locations after earlier filters.
