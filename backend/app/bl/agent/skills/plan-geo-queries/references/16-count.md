...
Use the latest subject-chain step as input. Make `count` the final step and plan output; no later step may consume it. Collapse repeated entities first when the request means distinct entities.
