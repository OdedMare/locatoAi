...
from app.service.models.probe_request import ModelsProbeRequest
from app.service.models.response import ModelsResponse
...
router.add_api_route(
    "/api/models", list_models, methods=["GET"], response_model=ModelsResponse
)
router.add_api_route(
    "/api/models", probe_models, methods=["POST"], response_model=ModelsResponse
)
